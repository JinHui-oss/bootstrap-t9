...
function StaffSecurity() {
  ...
  const { id } = useParams()
  const memberCollectionRef = doc(db, "Staff", id);
    ...
    try{
      ...
      const user = auth.currentUser
        ...
        if(user.emailVerified){
          console.log('The account has been verified and button is disabled.')
    ...
    <div className='setting-content'>
      ...
      <div className='setting-content-body'>
        ...
        <Card>
          ...
          <Button variant="primary" href={`/Staff/Account/PasswordUpdate/${id}`}>Change Password</Button>
        </Card.Body>
      </Card>
    </div>

    ...
    useEffect(() => {
      const getKit = async () => {
        ...
        if(user){
          ...
          // Composite Query 
          const q1 = query(kitCollectionRef, where("Status", "==", "Returned"), where("id", "==", id))
         ...
         <Form onSubmit={NewData} className="form-create">
           ...
           // {moment.unix(time).format("MM/DD/YYYY")}
            return(   
             ...
             <Button className= "Back-Action" href="/Staff/Returned">Back</Button>
             <br />
           </div>
           )
         })}         
